...
import inspect
import importlib
from aspectcompliance.joinpoint import JoinPoint
from aspectcompliance.matcher import matches_pointcut
...
def make_wrapper(func, advice):
    ...
    def wrapper(*args, **kwargs):
        # Ensure JoinPoint.proceed() can call the original function.
        jp = JoinPoint(func, args, kwargs, target=func)
        return advice(jp)
    return wrapper